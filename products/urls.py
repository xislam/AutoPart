...
urlpatterns = [
    path('api/products_html/', ProductListView.as_view(), name='product-list'),
    ...
    path('popular_api/products_html/', PopularProductListView.as_view(), name='popular-product-list'),
    path('categories/', CategoryListView.as_view(), name='category-list'),
    path('api/products_html/<int:id>/', ProductDetailView.as_view(), name='product-detail'),
